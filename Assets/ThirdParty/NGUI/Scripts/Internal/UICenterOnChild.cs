...
public class UICenterOnChild : MonoBehaviour
{
	...
	public delegate void OnDragFinishedWithIndex(GameObject centerOBJ);
	public OnDragFinishedWithIndex onDragFinishedWithIndex;
	...
	void CenterOn (Transform target, Vector3 panelCenter)
	{
		...
		if(onDragFinishedWithIndex!=null)
		{
			onDragFinishedWithIndex(mCenteredObject);
		}
	}
