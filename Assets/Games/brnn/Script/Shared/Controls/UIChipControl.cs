...
namespace com.QH.QPGame.BRNN
{
	...
	{						
		public GameObject ChipPrefabs;								//金币	
		public GameObject Area_Chips = null;						//金币生成区域					
		public float	  distance = 80;							//其他玩家下注区域

		List<GameObject>  m_chipList = new List<GameObject>();		//储存玩家金币

		public int m_baseDepth = 10;								//层级
