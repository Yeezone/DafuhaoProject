...
namespace com.QH.QPGame.GDNN
{
	enum emCardType
	{
		...
		CT_SPECIAL_NIU9 = 11,
		//点数类型
		CT_SPECIAL_NIUNIU = 12,
		//特殊类型
		CT_SPECIAL_NIUNIUXW = 13,
		//特殊类型
		CT_SPECIAL_NIUNIUDW = 14,
		//特殊类型
		CT_SPECIAL_BOMEBOME = 15,
		//特殊类型
		CT_SPECIAL_FIVECOLOR	= 16,
		//特殊类型
		CT_SPECIAL_FIVESMALL	= 17,
		//特殊类型
	...
	public class GameLogic
	{
		...
		//当前游戏状态
		public const ushort GAME_SCENE_FREE = (ushort)GameState.GS_FREE;
		//空闲状态
		public const ushort GAME_SCENE_PLACE_JETTON = (ushort)GameState.GS_PLAYING;
		//游戏状态
		public const ushort GAME_SCENE_GAME_END	= (ushort)GameState.GS_PLAYING + 1;
		//结束状态

		//赔率定义
		public const byte RATE_TWO_PAIR = 12;
		//对子赔率
		public const byte SERVER_LEN = 32;
		//房间长度

		//玩家索引
		public const byte AREA_COUNT = 5;
		//下注区域数目

		//下注区域
		public const byte ID_TIAN_MEN = 1;
		//天
		public const byte ID_DI_MEN = 2;
		//地
		public const byte ID_XUAN_MEN = 3;
		//玄
		public const byte ID_HUANG_MEN = 4;
		//黄

		public const ushort MAX_APPLY_BANKER = 6;
		//申请上庄人数上限
		public const byte NULL_CHAIR = 255;
		//空用户
		public const int MAX_SCORE_HISTORY = 60;
		//最大游戏记录
		...
		//数值掩码
		public const ushort MAX_COUNT = 5;
		//最大数目
