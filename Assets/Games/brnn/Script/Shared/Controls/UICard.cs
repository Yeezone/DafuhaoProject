...

{
	...
	public class UICard : MonoBehaviour {
		public 	Transform tweenTarget = null;				//当前物体

		public GameObject cardValue = null;					//当前卡牌值
		public GameObject cardCorol = null;					//卡牌花色
		public GameObject cardHead = null;					//卡牌头像花色 
		public GameObject kingColor = null;					//大小王花色
		public GameObject back = null;						//牌背面
		public GameObject cardHead_person = null;			//卡牌头像人物

		private string    carddName = null;					//卡牌名字
		public 	byte 	  GetCardTex;						//卡牌数据
