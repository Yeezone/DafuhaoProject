...
namespace System.Data.SQLite
{
    ...
    public class SQLiteHelper
    {
        ...
        public DataTable GetTable(string tabName)
        {
            return Select("SELECT * FROM sqlite_master WHERE ;");
        }
        ...
        public void Insert(string tableName, DataRow dr)
        {
            ...
            foreach (DataColumn kv in dr.Table.Columns)
            {
                if (sbCol.Length == 0)
                {
                    sbCol.Append("insert into ");
            ...
            foreach (DataColumn kv in dr.Table.Columns)
            {
                cmd.Parameters.AddWithValue("@v" + kv.ColumnName, dr[kv].ToString());
            }
