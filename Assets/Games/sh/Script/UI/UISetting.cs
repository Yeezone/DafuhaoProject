...

{
	public class UISetting : MonoBehaviour
	{
		...
		GameObject o_set_panel;
		public Transform o_set_music = null;
		public Transform o_set_effect = null;
		...
		public void Show(bool bshow)
		{
			...
			if (bshow == true)
			{
				...
				//                o_set_music.gameObject.GetComponent<UISlider>().sliderValue = PlayerPrefs.GetFloat("game_music", 0.5f);
				//                o_set_effect.gameObject.GetComponent<UISlider>().sliderValue = PlayerPrefs.GetFloat("game_effect", 0.5f);
				...
				//声音禁用按钮的显示
				if (PlayerPrefs.GetString("game_music_switch") == "off"&&PlayerPrefs.GetString("game_effect_switch") == "off")
				{
					UIGame.btn_chat_disabled.SetActive(true);
				}
				else
