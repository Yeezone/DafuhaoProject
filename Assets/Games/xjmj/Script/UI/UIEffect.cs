...
namespace com.QH.QPGame.XZMJ
{
    ...
    {
        static UIEffect instance = null;
        //
        GameObject o_panel = null;
        GameObject o_effect_bomb = null;
        GameObject o_effect_plane = null;
        GameObject o_effect_rocket = null;
        GameObject o_effect_bei = null;
        static bool _bShow = false;
        static EffectType _nType = EffectType.NULL;
        static int _nTick = 0;
        void Start()
        {
